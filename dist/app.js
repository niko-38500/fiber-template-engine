(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fiber_template_engine"] = factory();
	else
		root["fiber_template_engine"] = factory();
})(self, () => {
...
var parse_1 = __webpack_require__(/*! ./parse */ "./node_modules/node-html-parser/dist/parse.js");
...
var valid_1 = __webpack_require__(/*! ./valid */ "./node_modules/node-html-parser/dist/valid.js");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var type_1 = __importDefault(__webpack_require__(/*! ./nodes/type */ "./node_modules/node-html-parser/dist/nodes/type.js"));
function isTag(node) {
...
var he_1 = __importDefault(__webpack_require__(/*! he */ "./node_modules/he/he.js"));
...
var unitOfWork_1 = __webpack_require__(/*! ../unitOfWork/unitOfWork */ "./src/unitOfWork/unitOfWork.ts");
var Fiber = /** @class */ (function () {
    function Fiber() {
        this.unitOfWork = new unitOfWork_1.UnitOfWork();
    }
    Fiber.prototype.render = function (element, container) {
...
var dom_1 = __webpack_require__(/*! ../vdom/dom */ "./src/vdom/dom.ts");
var UnitOfWork = /** @class */ (function () {
    function UnitOfWork() {
        this.nextUnitOfWork = undefined;
        requestIdleCallback(this.workLoop.bind(this));
    }
    UnitOfWork.prototype.commitRoot = function () {
        this.commitWork(this.workInProgressFiber.firstChild);
        this.workInProgressFiber = undefined;
    };
    UnitOfWork.prototype.commitWork = function (fiber) {
        if (!fiber) {
            return;
        }
        var domParent = fiber.parent.domElement;
        domParent === null || domParent === void 0 ? void 0 : domParent.appendChild(fiber.domElement);
        this.commitWork(fiber.firstChild);
        this.commitWork(fiber.sibling);
    };
    UnitOfWork.prototype.performUnitOfWork = function (fiber) {
        if (!fiber.domElement) {
            fiber.domElement = (0, dom_1.createDom)(fiber);
        }
        var previousSibling;
        fiber.children.forEach(function (children, key) {
            var newFiber = {
                type: children.type,
    ...
    UnitOfWork.prototype.workLoop = function (deadline) {
...
var createDom = function (element) {
    var dom = 'text' === element.type
        ? document.createTextNode(element.props.nodeValue)
        : document.createElement(element.type);
    Object.keys(element.props).forEach(function (props) {
...
var ElementBuilder = /** @class */ (function () {
    ...
    ElementBuilder.createElement = function (type, props) {
        var children = [];
    ...
    ElementBuilder.createTextElement = function (text) {
        return {
            type: 'text',
            props: {
                nodeValue: text
...
var element_builder_1 = __importDefault(__webpack_require__(/*! ./element.builder */ "./src/vdom/element.builder.ts"));
var HtmlParser = /** @class */ (function () {
    function HtmlParser() {
    }
    HtmlParser.prototype.parse = function (element) {
        var parsedHtml = (0, node_html_parser_1.parse)(element, {
        ...
        var children = this.getNodesWithoutWhiteSpace(parsedHtml), childElements = [];
        for (var _i = 0, children_1 = children; _i < children_1.length; _i++) {
            var child = children_1[_i];
            childElements.push(this.processNode(child));
        }
        return element_builder_1.default.createElement.apply(element_builder_1.default, __spreadArray(['root', {}], childElements, false));
    };
    HtmlParser.prototype.getNodesWithoutWhiteSpace = function (node) {
        var children = node.childNodes;
        return children.filter(function (child) {
            return !(child instanceof node_html_parser_1.TextNode && child.isWhitespace);
        });
    };
    HtmlParser.prototype.processNode = function (node) {
        var _a;
        var type = (_a = node.tagName) !== null && _a !== void 0 ? _a : 'text';
        if (0 < node.childNodes.length) {
            return element_builder_1.default.createElement.apply(element_builder_1.default, __spreadArray([type,
                'text' === type ? { nodeValue: node.text } : node.attrs], this.processChildNode(this.getNodesWithoutWhiteSpace(node)), false));
        }
        return element_builder_1.default.createElement(type, 'text' === type ? { nodeValue: node.text } : node.attrs);
    };
    HtmlParser.prototype.processChildNode = function (child) {
        var _this = this;
        var elements = [];
        child.forEach(function (node) {
            var _a;
            var type = (_a = node.tagName) !== null && _a !== void 0 ? _a : 'text';
            var element = element_builder_1.default.createElement.apply(element_builder_1.default, __spreadArray([type,
                'text' === type ? { nodeValue: node.text } : node.attrs], _this.processChildNode(_this.getNodesWithoutWhiteSpace(node)), false));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Fiber = exports.HtmlParser = void 0;
var html_parser_1 = __webpack_require__(/*! ./vdom/html.parser */ "./src/vdom/html.parser.ts");
Object.defineProperty(exports, "HtmlParser", ({ enumerable: true, get: function () { return html_parser_1.HtmlParser; } }));
var fiber_1 = __webpack_require__(/*! ./fiber/fiber */ "./src/fiber/fiber.ts");
Object.defineProperty(exports, "Fiber", ({ enumerable: true, get: function () { return fiber_1.Fiber; } }));
